...
interface BigQueryLayoutProps {
  children: React.ReactNode;
}

export default function BigQueryLayout({ children }: BigQueryLayoutProps) {
  return (
    ...
    <div className="flex h-screen bg-gray-50 text-gray-900 overflow-hidden">
      ...
      <div className="flex flex-col flex-1 overflow-y-auto">
        ...
        {/* Área Principal de Contenido (BigQuery) */}
        {/* El children es el contenido de app/bigquery/page.tsx */}
